# player/attack/melee/sword/knockback
    ## ベクトル作る
        execute positioned as @n[tag=attack_tmp] facing entity @s feet positioned 0.0 0.0 0.0 rotated ~ -25 positioned ^ ^ ^1.5 summon marker run function system:function/pos_to_motion/input
    ## プレイヤーかそれ以外か
