# player/attack/melee/sword/knockback
    ## ベクトル作る
        execute anchored feet positioned as @n[tag=attack_tmp] facing entity @s feet positioned 0.0 0.0 0.0 rotated ~ ~-20 positioned ^ ^ ^0.75 summon marker run function system:function/pos_to_motion/input
    ## プレイヤーかそれ以外か
